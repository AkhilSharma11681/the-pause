...
export default function Navbar() {
  ...
  const animatedShadow = useTransform(
    scrollProgress,
    [0, 1],
    ['0 2px 8px rgba(0,0,0,0.0)', '0 8px 32px rgba(0,0,0,0.1),inset 0 1px 0 rgba(255,255,255,0.8)']
  )
  ...
  useEffect(() => {
    ...
    const fn = () => {
      scrollProgress.set(getScrollProgress(window.scrollY, SCROLL_THRESHOLD))
    }
