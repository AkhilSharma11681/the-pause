...
export const metadata: Metadata = {
  title: 'The Pause — Online Psychological Care',
  description: 'A calm space for therapy, healing, and mental wellness. Book a session with certified psychologists online.',
}
